...
# GUIDE
tutorial on how to make an library u made registered: go to Scheduler.cpp and put this inside the Anetia_getluastate: Environment::Libraries::LIBRARYNAME::Register( LuaState ); you must include ur library in Scheduler.cpp
# CRASHES
